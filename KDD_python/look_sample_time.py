...
def avgTravelTime(in_file):
    ...
    out_suffix = '_split_avg_travel_time1'
    ...
    fw.writelines(','.join(['"intersection_id"', '"tollgate_id"', '"time_window"', '"avg_travel_time"','"start_month"', '"start_day"','"start_hour"', '"start_minute"']) + '\n')
    #用逗号来连接指标名并换行
