...
file_suffix = '.csv'
path = '/Users/apple/code_tool/KDD_run/KDD_r/volume/volume_vehicle_model/'   # set the data directory（改文件路径）

def avgVolume(in_file):

    out_suffix = '_split_vehicle_model2'        #---
    ...
    fw.writelines(','.join(['"tollgate_id"', '"time_window"', '"direction"', '"volume_vehicle_model2"',  #---
...
def main():
    ...
    in_file = 'volume_vehicle_model2_training'    #-------随着车型每次改变
    avgVolume(in_file)
