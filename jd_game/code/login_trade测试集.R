...
trade_login_full_test = cbind(trade_full,tradeId_login_full[,names_use])  #--------------


#write.csv(trade_login_full_test,'trade_login_full_test2.csv',row.names = FALSE)
